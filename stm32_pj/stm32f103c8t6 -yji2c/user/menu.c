...
Menu_table  table[30]=
{
    ...
    {1,4,2,5,0,(*Data)},	//二级界面 数据
    {2,1,3,6,0,(*Time)},	//二级界面 日期
    {3,2,4,7,0,(*LOG)},	//二级界面 LOG
    {4,3,1,8,0,(*Play)},	//二级界面 休闲
		
		{5,5,5,5,1,(*Datashow)},		//三级界面：测量界面
		{6,6,6,6,2,(*Timeshow)},				//三级界面：时间界面
		{7,7,7,7,3,(*LOGshow)},								//三级界面：校院徽LOG显示
		{8,8,8,8,4,(*Playshow)},				//三级界面：作者和相关项目信息
