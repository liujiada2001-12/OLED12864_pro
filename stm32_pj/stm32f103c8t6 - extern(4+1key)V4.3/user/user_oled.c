...
{
	OLED_Clear();
	OLED_Chinese16(1,1,22);//
	OLED_Chinese16(1,2,23);//
	OLED_Chinese16(1,3,24);//
	OLED_Chinese16(1,4,25);//
}
...
{
		OLED_Chinese16(1,1,0);//riqi
		OLED_Chinese16(1,2,1);//
		OLED_ShowString(1,9,"        ");
	
		OLED_Chinese16(2,1,44);//log
		OLED_Chinese16(2,2,47);//
		OLED_Chinese(2,3,39);//
		OLED_ShowString(2,9,"        ");
	
		OLED_Chinese16(3,2,19);//xiuxian
		OLED_Chinese16(3,3,20);//
		OLED_ShowString(3,9,"        ");
	
		OLED_Chinese16(4,2,26);//
		OLED_Chinese16(4,3,27);//
		OLED_ShowString(4,9,"        ");
}
